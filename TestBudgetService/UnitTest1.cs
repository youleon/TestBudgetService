...
namespace TestBudgetService
{
    public class BudgetTests
    {
        ...
        public void QueryOneMonth()
        {
            ...
            {
                new Budget { YearMonth = "202210", Amount = 3100, },
                new Budget { YearMonth = "202211", Amount = 3100, },
                new Budget { YearMonth = "202212", Amount = 3100, },
            });
        ...
        public void QueryCrossTwoMonth()
        {
            ...
            _budgetRepo.GetAll().Returns(new List<Budget>
            {
                new Budget { YearMonth = "202210", Amount = 310, },
        ...
        public void QueryCrossThreeMonth()
        {
            ...
            _budgetRepo.GetAll().Returns(new List<Budget>
            {
                new Budget { YearMonth = "202210", Amount = 310, },
                new Budget { YearMonth = "202211", Amount = 3000, },
                new Budget { YearMonth = "202212", Amount = 31, }
            });
            _testBudgetService = new BudgetService(_budgetRepo);
            BudgetShouldBe(3023,
                           new DateTime(2022, 10, 30)
